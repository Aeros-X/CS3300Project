    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('portfolio', models.OneToOneField(default=None, on_delete=django.db.models.deletion.CASCADE, to='scheduling_app.portfolio')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ...
                ('portfolio', models.ForeignKey(default=None, on_delete=django.db.models.deletion.CASCADE, to='scheduling_app.portfolio')),
            ],
        ),
    ]
